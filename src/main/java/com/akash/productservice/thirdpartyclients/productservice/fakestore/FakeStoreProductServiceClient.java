...
public class FakeStoreProductServiceClient {
    ...
    public FakeStoreProductDto getProductById(Long id) throws NotFoundExcpetion {
        RestTemplate restTemplate = restTemplateBuilder.build();
    ...
    public FakeStoreProductDto deleteProductById(Long id) throws NotFoundExcpetion {
        RestTemplate restTemplate = restTemplateBuilder.build();
//        restTemplate.delete(productByIdUrl, id);
    ...
    public FakeStoreProductDto updateProductById(Long id, GenericProductDto genericProductDto) throws NotFoundExcpetion {
        RestTemplate restTemplate = restTemplateBuilder.build();
